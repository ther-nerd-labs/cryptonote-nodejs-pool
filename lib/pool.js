...
function recordShareData(miner, job, shareDiff, blockCandidate, hashHex, shareType, blockTemplate){
    ...
    service.recordShareData(config.coin, job, slushMiningEnabled, dateNow, miner, cleanupInterval, blockCandidate)
	.then(replies => {
            ...
            if (blockCandidate){
                ...
                service.recordBlockCandidate(config.coin, job.height, hashHex, dateNowSeconds, blockTemplate.difficulty, totalShares, totalScore)
